...
namespace Ruper.DAL.Migrations
{
    ...
    [Migration("20230210191054_AddOrderTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ruper.DAL.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Ruper.DAL.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Ruper.DAL.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Ruper.DAL.Entities.Order", b =>
                {
                    b.HasOne("Ruper.DAL.Entities.ProductColor", "ProductColor")
                        .WithMany("Orders")
                        .HasForeignKey("ProductColorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ruper.DAL.Entities.ApplicationUser", "User")
                        .WithMany("Orders")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Ruper.DAL.Entities.ProductColor", b =>
                {
                    b.HasOne("Ruper.DAL.Entities.Color", "Color")
                        .WithMany("ProductColors")
                        .HasForeignKey("ColorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ruper.DAL.Entities.Product", "Product")
                        .WithMany("ProductColors")
